...
public class Command extends BukkitCommand {
  ...
  public boolean execute(CommandSender sender, String commandLabel, String[] args) {
    ...
    if (!subCommandOptional.isPresent()) {
      sender.sendMessage(ChatColor.RED + "Unknown subcommand for arguments.This Command Is Unknown To Anpcs check the command again. ");
      return false;
    } 
    try {
      ...
      sender.sendMessage(ChatColor.RED + "Failed to execute anpcs command.");
      e.printStackTrace();
