...
public class NPCModel {
  ...
  private int refreshSkinDuration;
  ...
  private NPCModel() {
    this.hologramLines = Collections.singletonList("/anpcs lines");
  ...
  public int getRefreshSkinDuration() {
    return refreshSkinDuration;
  }

  public void setRefreshSkinDuration(int refreshSkinDuration) {
    this.refreshSkinDuration = refreshSkinDuration;
  }

  public NPCModel withRefreshSkinDuration(int refreshSkinDuration) {
    setRefreshSkinDuration(refreshSkinDuration);
    return this;
  }
