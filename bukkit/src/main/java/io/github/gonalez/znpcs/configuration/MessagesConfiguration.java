...
public class MessagesConfiguration extends Configuration {
  ...
  public String noPermission = "&cYou do not have permission to execute this &7[&fanpcs&7]&c command.";

  @ConfigurationKey(
      name = "SUCCESS",
      description = "Message for.success")
  public String success = "&aDone...Updating &7[&fanpcs&7]";

  @ConfigurationKey(
      name = "INCORRECT_USAGE",
      description = "Message for incorrect &7[&fanpcs&7] command usage")
  ...
  @ConfigurationKey(
      name = "NPC_NOT_FOUND",
      description = "Message for ANPC not found")
  public String npcNotFound = "&cHey!, I couldn't find a anpc with this id.";
  ...
  public String pathStart = "&aDone, now walk where you want the npc to, when u finish type /anpcs path exit.";
  ...
  public String npcFound = "&cThere is already a anpc with this id.";
